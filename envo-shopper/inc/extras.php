...
if (!function_exists('envo_shopper_generate_construct_footer_widgets')) :
     ...
     */
    add_action('envo_shopper_copyright_footer', 'envo_shopper_generate_construct_footer_widgets', 10);
...
if (!function_exists('envo_shopper_copyright_construct_footer')) :
    /**
     * Build footer
     */
    add_action('envo_shopper_copyright_footer', 'envo_shopper_copyright_construct_footer', 20);

    function envo_shopper_copyright_construct_footer() {
        ?>
